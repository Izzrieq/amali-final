        ...
        <table>
            ...
            while ($pekerja = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                        <button class="operation"><a href="update_pekerja.php?nokp=<?php echo $pekerja['nokp'];?>">UPDATE</a></button>
                        <button class="operation"><a href="delete_pekerja.php?nokp=<?php echo $pekerja['nokp'];?>">DELETE</a></button>
                    </td> 
                </tr> 
            <?php $bil = $bil + 1; 
            } 
